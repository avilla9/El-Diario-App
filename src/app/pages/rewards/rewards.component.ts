      ...
      articles: [
        {
          ...
          short_description: 'Te retamos a adivinar la palabra que se esconde detrás y gana 20 Soles.',
          cta: 'Quiero resolver',
        ...
        },
        {
          ...
          short_description: 'Te lanzamos un reto que pondrá a prueba tu capacidad para pensar de otra manera. Resuelve el acertijo y gana 15 Soles',
          cta: '',
          cta_content: '',
          internalRoute: '',
        ...
        },
        {
          ...
          title: 'El intruso',
          created_at: '2022/08/03 12:00',
          description: 'Hay algo en la aplicación que no debería estar… Si eres capaz de encontrarlo, dinos qué es a través del buzón que encontrarás en el menú y ganarás 30 Soles',
      ...
      articles: [
        {
          ...
          created_at: '2022/08/03 12:00',
          description: 'Comparte la APP con tus compañeros y gana 30 Soles por cada uno que se los descargue. Solo una condicioón: tienen que ser nuevos usuarios ;)',
          short_description: 'Comparte la APP y gana Soles',
          cta: '',
          cta_content: '',
          internalRoute: '',
        ...
        },
        {
          ...
          created_at: '2022/08/03 12:00',
          description: 'Comparte 10 de los artículos que publiquemos este mes y ganarás 20 Soles. ¡No pierdas la oportunidad!',
      ...
      articles: [
        {
          ...
          created_at: '2022/08/03 12:00',
          description: 'Dale a like a 10 de los artículos que publiquemos este mes y ganarás 20 Soles. ¡No pierdas la oportunidad!',
